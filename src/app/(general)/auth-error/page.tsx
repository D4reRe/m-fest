...
const errorMap = {
  ...
  [Error.AccessDenied]: (
    <p>
      You are not allowed to access this page. Please contact us if you think
      this is a mistake.
  ...
  [Error.Verification]: (
    <p>
      Your account is not verified. Please verify your account before logging
      in.
  ...
  [Error.Default]: (
    <p>
      There is a problem with your request for login. Please contact us if this
      error persists.
