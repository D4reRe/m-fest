...
const ContactSection = () => {
  return (
    <section className=" py=16 sm:py-20" id="contact">
      <div className="pl-4 sm:pl-16 pb-14 pt-20">
        <h1 className="text-6xl sm:text-6xl font-extrabold ">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="mx-16">
              ...
              <div className="inline-flex max-w-3xs mx-auto">
                <h3 className="text-2xl font-medium text-primary mb-5 pb-3 px-5 max-w-xs ">
                  Our Location on Google Maps
                </h3>
              </div>
              <div className="rounded-lg shadow-lg overflow-hidden w-72 h-52 lg:h-92 lg:w-112">
                <iframe
