                ...
                >
                    <div key={1}>
                        <Button
                            asChild
                            size="lg"
                            className="drop-shadow-xl/50 w-72 h-18 group relative overflow-hidden bg-slate-900/30 hover:bg-slate-800/50 backdrop-blur-md border border-white/20 text-white duration-300 shadow-[0_0_20px_rgba(0,0,0,0.1)] hover:shadow-[0_0_20px_rgba(34,211,238,0.2)] rounded-xl px-6 py-12 text-lg transition-all duration-300shadow-[0_0_20px_rgba(0,0,0,0.1)]"
                        >
                            <Link
                                href="/competitions"
                                ...
                                prefetch
                            >
                                <span className="text-wrap text-center text-3xl mx-auto">
